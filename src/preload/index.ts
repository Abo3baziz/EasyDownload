...
const api: PreloadApi = {
  ...
  downloadPlaylist: (options) => ipcRenderer.invoke(IPC_CHANNELS.playlistDownload, options),
  cancelPlaylist: (playlistId) => ipcRenderer.invoke(IPC_CHANNELS.playlistCancel, { id: playlistId }),
